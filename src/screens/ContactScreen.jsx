...
const styles = {
  ...
  heroSub:     { fontSize: 11, fontWeight: 500, color: 'rgba(255,255,255,.85)', lineHeight: 1.5, maxWidth: 280 },
  ...
  errorMsg:    { fontSize: 11, fontWeight: 600, color: 'var(--re)', background: 'var(--rel)', borderRadius: 8, padding: '8px 10px' },
  ...
  successSub:  { fontSize: 11.5, fontWeight: 500, color: 'var(--g5)', lineHeight: 1.5, maxWidth: 260 },
}
