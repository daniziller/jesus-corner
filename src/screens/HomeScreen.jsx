...
const styles = {
  ...
  tutorialTip:   { background: 'var(--olt)', border: '0.5px dashed rgba(249,115,22,.4)', borderRadius: 11, padding: 11, fontSize: 12.5, fontWeight: 500, color: 'var(--g6)', lineHeight: 1.5 },
