...
const styles = {
  ...
  bErrorText: { fontFamily: 'var(--font-bento)', fontSize: 11.5, fontWeight: 600, color: 'var(--bento-accent)', margin: '0 0 8px' },
  ...
  error: { fontFamily: 'var(--font-bento)', fontSize: 12.5, fontWeight: 600, color: 'var(--bento-accent)', background: 'var(--bento-mark)', borderRadius: 12, padding: '8px 10px', marginBottom: 8 },
  ...
  completeChallengeBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, width: '100%', border: 'none', background: 'var(--bento-sand)', color: 'var(--bento-sand-icon)', borderRadius: 12, padding: '10px 12px', marginTop: 12, fontFamily: 'var(--font-bento)', fontSize: 12, fontWeight: 700, cursor: 'pointer' },
