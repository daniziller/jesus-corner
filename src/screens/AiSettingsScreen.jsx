    ...
    <div style={styles.screen}>
      ...
      <div style={styles.body}>
        <div style={styles.card}>
          ...
          <ToggleRow label={L('reflectionLabel')} sub={L('reflectionSub')} value={reflectionOn} onChange={toggleReflection} last />
        </div>
...
function ToggleRow({ label, sub, value, onChange, last, noBorder }) {
  return (
    <div style={{ ...styles.toggleRow, ...(last ? { paddingBottom: 0 } : {}), ...(noBorder ? { borderBottom: 'none' } : {}) }}>
...
const styles = {
  ...
  headerSub: { fontFamily: 'var(--font-bento)', fontSize: 12, fontWeight: 500, color: 'var(--bento-t3)', margin: '3px 0 0' },
  body: { flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', padding: '0 20px', display: 'flex', flexDirection: 'column', gap: 12 },
  ...
  toggleLabel: { fontFamily: 'var(--font-bento)', fontSize: 14.5, fontWeight: 700, color: 'var(--bento-ink)', margin: '0 0 3px' },
  toggleSub: { fontFamily: 'var(--font-bento)', fontSize: 11.5, fontWeight: 500, color: 'var(--bento-t3)', margin: 0 },
  ...
  sectionLabel: { fontFamily: 'var(--font-bento)', fontSize: 10.5, fontWeight: 800, letterSpacing: '.12em', textTransform: 'uppercase', color: 'var(--bento-t4)', margin: '0 0 6px' },
  sectionHint: { fontFamily: 'var(--font-bento)', fontSize: 12.5, fontWeight: 500, color: 'var(--bento-t3)', margin: '0 0 14px' },
  ...
  toneLabel: { fontSize: 13.5, fontWeight: 800 },
  toneSub: { fontSize: 10.5, fontWeight: 600 },
  clearBtn: { width: '100%', border: 'none', background: 'none', marginTop: 14, textAlign: 'left', padding: 0, fontFamily: 'var(--font-bento)', fontSize: 12.5, fontWeight: 600, color: 'var(--bento-accent)', cursor: 'pointer' },
