...
const styles = {
  ...
  addBtn:       { width: 28, height: 28, borderRadius: '50%', background: 'var(--grad-primary)', boxShadow: 'var(--shadow-premium)', border: 'none', color: 'white', fontSize: 18, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font)', lineHeight: 1, padding: 0 },
  ...
  btnAdd:       { flex: 1, background: 'var(--grad-primary)', boxShadow: 'var(--shadow-premium)', borderRadius: 9, padding: 8, border: 'none', fontFamily: 'var(--font)', fontSize: 11, fontWeight: 700, color: 'white', cursor: 'pointer' },
  ...
  emptySub:     { fontSize: 11.5, fontWeight: 500, color: 'var(--g5)', lineHeight: 1.5 },
  ...
  folderText:   { fontSize: 12.5, fontWeight: 600, color: 'var(--bk)', lineHeight: 1.4, marginBottom: 2 },
