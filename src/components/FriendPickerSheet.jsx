...
const s = {
  ...
  sheet: { width: '100%', maxWidth: 'var(--max-width)', maxHeight: '80vh', background: 'var(--bento-bg)', borderRadius: '34px 34px 0 0', boxShadow: '0 -18px 40px rgba(0,0,0,.18)', display: 'flex', flexDirection: 'column' },
