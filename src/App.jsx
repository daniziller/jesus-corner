...
export default function App() {
  ...
  const bentoScreen = ['home', 'routine', 'journey', 'notes', 'studies', 'profile', 'stats', 'adjustPlan', 'aiSettings', 'chapterRoom', 'monthRecap', 'prayer', 'routineComplete', 'language', 'groupAdmin', 'createStudy', 'studyProposal', 'groupPlanProposal', 'groupPlanReader'].includes(activeTab)
